...
export const FAQDATA = [
  ...
  },
  {
    ...
    answer: '+ Có, sau khi đặt hàng thành công, bạn sẽ nhận được mã vận đơn để theo dõi trạng thái giao hàng.'
  },
  {
    id: 3,
    question: 'Chính sách đổi trả của cửa hàng là gì?',
    answer: '+ Bạn có thể đổi/trả sản phẩm trong vòng 7 ngày nếu sản phẩm bị lỗi từ nhà sản xuất hoặc không đúng mô tả.'
  },
  {
    id: 4,
    question: 'Nội thất được làm từ những chất liệu gì?',
    answer: '+ Các sản phẩm nội thất được làm từ gỗ tự nhiên, gỗ công nghiệp, kim loại, kính và vải bọc cao cấp.'
  },
  {
    id: 5,
