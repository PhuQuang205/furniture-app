    ...
    <footer className='bg-greenly text-white'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8'>
          <div className=''>
            ...
            <p className='text-white/80 mb-8 leading-relaxed max-w-sm'>
              Hoàng Hà là thương hiệu nội thất uy tín, mang đến các sản phẩm thiết kế tinh tế, chất lượng cao, giúp
              không gian sống và làm việc của bạn thêm hiện đại và tiện nghi.
            </p>
          ...
          <div>
            ...
            <ul className='space-y-4 flex flex-col'>
              {companyLinks.map((item, index) => (
                <Link key={index} className='text-white/80 hover:text-white transition-colors' href={item}>
                  {item.name}
                </Link>
              ))}
            </ul>
          ...
          <div>
            <h3 className='text-lg font-semibold mb-6'>Thông tin của chúng tôi</h3>
          ...
          <div>
            ...
            <div className='space-y-3'>
              <p className=' text-white/80 hover:text-white transition-colors'>{contactInfo.phone}</p>
              <p className='text-white/80 hover:text-white transition-colors'>{contactInfo.email}</p>
      ...
      <div className='bg-yelly px-8 py-4 max-sm:py-2 lg:px-4'>
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-center gap-4'>
          <p className='text-black text-sm'>Copyright © 2025 Furniture. All Rights Reserved.</p>
