...
const chairs = ['Ghế gỗ', 'Ghế nhựa', 'Ghế xoay (ghế văn phòng)', 'Ghế sofa', 'Ghế armchair (ghế bành)', 'Ghế bar']
...
const IntroCategorySection = () => {
  return (
    <section className='container mx-auto'>
      <div className='px-8 lg:px-0 pb-14 lg:pb-16'>
        <div className='flex flex-col items-center lg:items-start gap-4 mb-8'>
          ...
          <h1 className='text-3xl font-semibold'>
            <span className='text-greenly'>Danh mục</span> sản phẩm
          </h1>
        </div>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
            ...
            <div className='space-y-4 z-10'>
              <div className='rounded-full bg-white inline-block px-3 py-1'>
                <p className='font-semibold text-sm'>
                  <span className='text-yelly font-bold'>1500+</span> sản phẩm
                </p>
              </div>
              <h3 className='text-3xl lg:text-4xl font-semibold text-black'>Ghế</h3>
          ...
          <div className='bg-subbg rounded-2xl flex justify-between items-center p-6 relative overflow-hidden'>
            <div className='space-y-4 z-10'>
              <div className='rounded-full bg-white inline-block px-3 py-1'>
                <p className='font-semibold text-sm'>
                  <span className='text-yelly font-bold'>750+</span> sản phẩm
                </p>
              </div>
              <h3 className='text-3xl lg:text-4xl font-semibold text-black'>Bàn</h3>
              <div className='text-gray-700 text-sm space-y-1'>
                {tables.map((item, i) => (
                  <p key={i}>{item}</p>
                ))}
          ...
          <div className='bg-subbg rounded-2xl flex justify-between items-center p-6 relative overflow-hidden'>
            <div className='space-y-4 z-10'>
              <div className='rounded-full bg-white inline-block px-3 py-1'>
                <p className='font-semibold text-sm'>
                  <span className='text-yelly font-bold'>450+</span> sản phẩm
                </p>
              </div>
              <h3 className='text-3xl lg:text-4xl font-semibold text-black'>Kệ tủ</h3>
              <div className='text-gray-700 text-sm space-y-1'>
                {cabinets.map((item, i) => (
                  <p key={i}>{item}</p>
                ))}
